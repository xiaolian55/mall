...
import com.nikki.mall.tiny.service.RedisService;
...
@Service
public class UsmMemberServiceImpl implements UmsMemberService {
    @Autowired
    ...
    @Override
    public CommonResult genAuthCode(String telehone) {
        ...
        //验证码绑定手机号并存储到redis
        redisService.set(REDIS_KEY_PREFIX_AUTO_CODE+telehone,sb.toString());
        redisService.expire(REDIS_KEY_PREFIX_AUTO_CODE+telehone,AUTH_CODE_EXPIRE_SECONDS);
